...
private:
	...
	void setup_cubemap()
	{
		...
		{
			glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, GL_RGB16F, skybox_size, skybox_size, 0, GL_RGB, GL_FLOAT, nullptr);
		}
...
private:
	const unsigned int skybox_size = 1024;
