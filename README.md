...
- [andreasfertig/cppinsights: C++ Insights - See your source code with the eyes of a compiler (github.com)](https://github.com/andreasfertig/cppinsights)
- [FunctionDou/STL: STL源码分析 (github.com)](https://github.com/FunctionDou/STL)
- [【UnityShader】 有向距离场（SDF）（13） - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/633589464)
- [URP代码结构以及GPU架构（万字长文） - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/629678819)
- [qinguoyi/TinyWebServer: :fire: Linux下C++轻量级WebServer服务器 (github.com)](https://github.com/qinguoyi/TinyWebServer)
- [(52 封私信 / 81 条消息) 为什么傅里叶变换可以把时域信号变为频域信号？ - 知乎 (zhihu.com)](https://www.zhihu.com/question/279808864/answer/552617806)
- [3Blue1Brown 动画制作教程(8)--利用傅里叶级数做动画 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/111526064)
- [3B1B 讲的卷积计算(高斯分布,CNN,傅里叶变换) - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/624524568)
...
- [0向往0 - 博客园 (cnblogs.com)](https://www.cnblogs.com/timlly/)
- [Epic Developer Community Learning | Tutorials, Courses, Demos & More – Epic Developer Community (epicgames.com)](https://dev.epicgames.com/community/unreal-engine/learning?source=epic_games)
- [(52 封私信 / 81 条消息) 如何用 c 语言写一个扔色子的程序？ - 知乎 (zhihu.com)](https://www.zhihu.com/question/386347847/answer/2576561977)
- [南京大学2023操作系统-P1\] (蒋炎岩)_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1Xx4y1V7JZ/?spm_id_from=333.999.0.0&vd_source=f96c6c1bf01b381d557447620e03d905)
- [Unity游戏性能分析最终指南 01 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/625481328)
- [SLYNYRD](https://www.slynyrd.com/)
- [详解 23 种设计模式 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/625554756)
- [D3D12 Work Graphs Preview - DirectX Developer Blog (microsoft.com)](https://devblogs.microsoft.com/directx/d3d12-work-graphs-preview/)
- [内存性能优化小结 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/599380805)
- [(10条消息) Unity3D 渲染管线全流程解析_unity渲染管线_窗外听轩雨的博客-CSDN博客](https://blog.csdn.net/Q540670228/article/details/120094859)
