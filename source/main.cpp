...
int main()
{
	...
	// ------------------------------------
	Shader shader(R"(resource\shader\stencil_testing.vs)", R"(resource\shader\stencil_testing.fs)");
	Shader shaderSingleColor(R"(resource\shader\stencil_testing.vs)", R"(resource\shader\stencil_single_color.fs)");
